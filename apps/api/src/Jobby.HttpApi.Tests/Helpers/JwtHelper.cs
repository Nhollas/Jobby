...
public static class JwtHelper
{
        ...
        string? privatePemKey = null)
    {
        ...
        RSA rsa = RSA.Create();
        var pem = privatePemKey?.ToCharArray() ?? TestPemPrivateKey.ToCharArray();
