...
export const Contact = ({ contact, boards, jobs }: Props) => {
  ...
  return (
    <Card className="z-50 h-full w-full max-w-lg overflow-scroll rounded-none border-0 transition-all animate-in fade-in-90 zoom-in-90 slide-in-from-bottom-10 duration-100 sm:slide-in-from-bottom-0">
      <CardHeader>
