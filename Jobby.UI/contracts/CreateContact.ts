...
export type CreateContactRequest = z.infer<typeof formSchema>;
...
export const formSchema = z.object({
  ...
  export const createContact = async (data: CreateContactRequest, client: AxiosInstance) => {
    return await client.post<CreateContactRequest, AxiosResponse<Contact>>("/contact/create", data);
  }